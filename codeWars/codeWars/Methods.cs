...
//    {
//        int arrayCounter = name.Count();

//        if (name == null || arrayCounter == 0) return "no one likes this";

//        if (arrayCounter == 1) return $"{name[0]} likes this";
//        if (arrayCounter == 2) return $"{name[0]} and {name[1]} like this";
//        if (arrayCounter == 3) return $"{name[0]}, {name[1]} and {name[2]} like this";
